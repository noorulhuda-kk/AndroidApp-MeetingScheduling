...
public class login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(login.this, R.color.primaryColor));
                                                        ...
                                                        if (task.isSuccessful()) {
                                                            ...
                                                            if (document != null && document.exists()) {
                                                                ...
                                                                if ("manager".equals(role)) {
                                                                    ...
                                                                    Toast.makeText(login.this, "You're employee, Log in from employee side", Toast.LENGTH_SHORT).show();
                                                                } else {
